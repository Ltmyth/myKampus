...
export default function DashboardLayout({ children }) {
  ...
  const getRoleBadgeColor = (role) => {
    switch (role) {
      ...
      case 'dean': return 'bg-emerald-100 text-emerald-900 border-emerald-300 font-extrabold';
      case 'faculty_admin': return 'bg-emerald-50 text-emerald-800 border-emerald-200';
      case 'lecturer': return 'bg-emerald-50 text-emerald-800 border-emerald-200';
